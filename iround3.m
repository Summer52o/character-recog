...
answer='';
answer=strcat(answer,answ(1));
[az,sz]=size(answ);

for i=2:sz
    if answ(i)=='l' && answ(i+1)=='l'
        answer=strcat(answer,'i');
        
    elseif answ(i)=='j' && answ(i+1)=='l'
        answer=strcat(answer,'j');
    elseif answ(i)=='l' && answ(i-1)=='l'
    elseif answ(i)=='l' && answ(i-1)=='j'
    else       
        answer=strcat(answer,answ(i));
    end
end
